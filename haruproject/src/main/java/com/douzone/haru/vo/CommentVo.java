...
public class CommentVo {
	...
	public String toString() {
		return "CommentVo [commentNo=" + commentNo + ", commentRegdate=" + commentRegdate + ", commentContents=" + commentContents + ", commentLike=" + commentLike + ", userNo=" + userNo + ", userName=" + userName + ", userPhoto=" + userPhoto + ", userEmail=" + userEmail + ", commentState="
				+ commentState + ", taskNo=" + taskNo + ", fileNo=" + fileNo + ", originName=" + originName + ", filePath=" + filePath + ", fileRegdate=" + fileRegdate + ", fileState=" + fileState + "]";
	}
